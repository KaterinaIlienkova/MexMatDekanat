...
class PersonalQAService:
    ...
    def submit_question(self, user_id: int, question_text: str) -> Dict[str, Any]:
        ...
        with self.uow_factory() as uow:
            ...
            try:
                question_id = uow.pqa_repository.create_question(user_id, question_text)
                return {
                    'success': True,
    ...
    def get_pending_questions(self) -> List[Dict[str, Any]]:
        ...
        with self.uow_factory() as uow:
            try:
                pending_questions = uow.pqa_repository.get_pending_questions()
    ...
    def get_question_details(self, question_id: int) -> Dict[str, Any]:
        ...
        with self.uow_factory() as uow:
            try:
                details = uow.pqa_repository.get_question_details(question_id)
    ...
    def answer_question(self, question_id: int, answer_text: str, staff_id: int) -> Dict[str, Any]:
        ...
        with self.uow_factory() as uow:
            ...
            try:
                ...
                result = uow.pqa_repository.answer_question(question_id, answer_text, staff_id)
                ...
                student_chat_id = uow.pqa_repository.get_student_chat_id(question_id)
